...
import Business.ConfigureAnEnterprise;
...
public class DB4OUtil {
    ...
    */
     ...
     */
    public synchronized void storeSystem(Enterprise system) {
     ...
     * @return EcoSystem
     */
    public Enterprise retrieveSystem(){
        ObjectContainer conn = createConnection();
        ObjectSet<Enterprise> systems = conn.query(Enterprise.class);
        Enterprise system;
        if (systems.size() == 0){
            system = ConfigureAnEnterprise.configureBusiness();
        }
        else{
